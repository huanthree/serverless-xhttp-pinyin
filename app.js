...
// 环境变量
const UUID = process.env.UUID || '6e796270-7828-47ef-bf1e-2bca2fd5f599'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const DOMAIN = process.env.DOMAIN || 'fi-01.freezehost.pro';                   // 域名或ip,留空将自动获取服务器ip
const NAME = process.env.NAME || 'freezehost-x';                    // 节点名称
const PORT = process.env.PORT || 12611;                     // http服务
